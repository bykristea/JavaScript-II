...
let allCaps = [];
runners.map(function (object,index,arr) {
...
const sizeFltr = function(object, index, arr) {
    if (arr[index].shirt_size === "L") {
        return true;
    }
    return false;
}

let largeShirts = runners.filter(sizeFltr);
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
const donations = runners.map(function(object, index, arr) {
